...
function kube_image_list_names_from_pods() {
...
function kube_image_list_names_from_pods_all_namespaces() {
  kubectl get pods -A -o=jsonpath="{range .items[*].spec.containers[*]}{.image}{'\n'}{end}" | sort -u
}

function kube_dump_all_logs_from_pods() {
  local pods
  local namespace="$1"
...
function kube_delete_replica_sets_all_namespaces() {
...
function kube_get_all_resources() {
  local namespace=${1:-default}
  shift
